...
if ',' in equipment_list1:
    items = [item.strip().strip('"') for item in equipment_list1.split(',')]
    equipment_list1 = '\n'.join([f"{i+1}. {item}" for i, item in enumerate(items)])
else:
    equipment_list1 = '1. ' + equipment_list1.strip()
...
if ',' in equipment_list2:
    items = [item.strip().strip('"') for item in equipment_list2.split(',')]
    equipment_list2 = '\n'.join([f"{i+1}. {item}" for i, item in enumerate(items)])
else:
    equipment_list2 = '1. ' + equipment_list2.strip()
