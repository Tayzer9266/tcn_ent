        ...
        def main():
            ...
            if option == "New": 
                with st.form("my_form"):
                    ...
                    if best_time:
                        st.write(f"Selected: {best_time.strftime('%I:%M %p')} (Military: {best_time.strftime('%H:%M')})")
                    ...
                    if start_time:
                        st.write(f"Selected: {start_time.strftime('%I:%M %p')} (Military: {start_time.strftime('%H:%M')})")
